...
namespace SassyStudio.Scss.Classifications
{
    ...
    sealed class ScssComment : ColorResolvingFormatDefinition
    {
        ...
        public ScssComment(IEditorFormatMapService service, IClassificationFormatMapService c)
            : base(service, "Comment", category: "{E0187991-B458-4F7E-8CA9-42C9A573B56C}", foreground: true)
        {
